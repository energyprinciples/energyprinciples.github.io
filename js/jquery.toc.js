 ...
 * @license     MIT
 * @version		https://github.com/nghuuphuoc/tocjs/commit/09e1aaa07dc83c50aeb3c30bcd423aa321a9e148
 * 
 * 2017.08.01	Modified section "Add anchor icon to heading" starting line #176 to disable adding anchor icon to headings
 * 
 */
        ...
        render: function() {
            ...
            if (this.options.heading) {
                $('<li/>').addClass('toc-heading')
                          .wrapInner($('<span/>').attr('href', '#').html(this.options.heading))
                          .appendTo($toc);
            }
